...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                na.setText(jj.getString("u_name"));
                                pl.setText(jj.getString("u_place"));
                                po.setText(jj.getString("u_post"));
                                pi.setText(jj.getString("u_pin"));
                                se.setText(jj.getString("section"));
                                ph.setText(jj.getString("u_contact"));
                                em.setText(jj.getString("u_email"));

                                String image = jj.getString("u_photo");
