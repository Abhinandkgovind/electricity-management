                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    t[i] = u.getString("title");//dbcolumn name in double quotes
                                    n[i] = u.getString("notification");//dbcolumn name in double quotes
                                    d[i] = u.getString("date");


                                }
                                li.setAdapter(new custom_view_notification(getApplicationContext(), t,n, d));//custom_view_service.xml and li is the listview object
